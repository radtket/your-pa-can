...
--------------------------------------------- */
	...
	function initChartAllSpecialties() {
		...
		const chartAllSpecialties = echarts.init(
			document.getElementById("chartAllSpecialties")
		);
...
--------------------------------------------- */
	function initChartWorkSettings() {
		const chartWorkSettings = echarts.init(
			document.getElementById("chartWorkSettings")
		);
